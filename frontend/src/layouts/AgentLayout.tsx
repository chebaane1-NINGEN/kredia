...
const AgentLayout: React.FC = () => {
  ...
  console.log('🤵 AgentLayout rendu - AGENT DASHBOARD ACTIF');

  const navItems: NavItem[] = [
    { to: '/agent', icon: LayoutDashboard, label: 'Dashboard', end: true },
    { to: '/agent/clients', icon: Users, label: 'Clients' },
    { to: '/agent/performance', icon: TrendingUp, label: 'Performance' },
    { to: '/agent/audit', icon: History, label: 'Audit' },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Kredia Agent</span>
            </div>
            <button 
