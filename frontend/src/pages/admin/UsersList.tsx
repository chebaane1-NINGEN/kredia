...
const UsersList: React.FC = () => {
  ...
  const executeBulkAction = async (action: string) => {
    try {
      ...
      addToast(`${selectedUsers.length} users ${action}d successfully`, 'success');
      setSelectedUsers([]);
      fetchUsers();
    } catch (err: any) {
  ...
  return (
    <div className="space-y-6">
      ...
      {selectedUsers.length > 0 && (
        <div className="finova-card p-4 bg-indigo-50 border-indigo-200 mb-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white text-sm font-bold rounded-xl hover:bg-emerald-700 transition-all active:scale-95 shadow-lg shadow-emerald-100"
              >
              ...
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2 bg-amber-600 text-white text-sm font-bold rounded-xl hover:bg-amber-700 transition-all active:scale-95 shadow-lg shadow-amber-100"
              >
                <Clock size={16} />
                Suspend
              </button>
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2 bg-rose-600 text-white text-sm font-bold rounded-xl hover:bg-rose-700 transition-all active:scale-95 shadow-lg shadow-rose-100"
              >
                <Ban size={16} />
                Block
              </button>
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2 bg-slate-900 text-white text-sm font-bold rounded-xl hover:bg-slate-800 transition-all active:scale-95 shadow-lg"
              >
                <Trash2 size={16} />
                Delete
              </button>
              ...
              {loading ? (
                Array.from({ length: 6 }).map((_, i) => (
                  <tr key={i} className="animate-pulse">
                    <td className="px-6 py-4"><div className="h-4 bg-slate-100 rounded w-4"></div></td>
